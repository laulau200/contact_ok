...
<div class="content">
  ...
  <p>J'ai pris des comp&eacute;tences sur cetains langages : <BR><BR> HTML, <BR>CSS, <BR> JAVASCRIPT, <BR> PYTHON, <BR> PHP, <BR> MYSQL... <BR> Et suis en train d'apprendre <em style=color:red;>JQUERY</em></p>
</div>
...
<button type="button" class="collapsible"><h2.color="black">Titre Professionnel TSSR(niveau V)</h2.color=></button>
<div class="content">
